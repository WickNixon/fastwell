  ...
  return (
    <div className="page page-top">
      ...
      <p className="body-sm mb-24">
        {profile?.first_name ?? ''} · {profile?.subscription_tier === 'member' ? 'Wicked Wellbeing member' : 'Fastwell subscriber'}
      </p>
      ...
      <p className="body-sm text-center mt-20" style={{ opacity: 0.5 }}>Fastwell v1.1.5</p>
    </div>
  );
}
